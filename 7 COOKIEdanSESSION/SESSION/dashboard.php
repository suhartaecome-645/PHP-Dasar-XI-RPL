...
<head>
	...
	<title>Sudah Login Session</title>
...
<body>
	<div class="container-fluid bg-primary-subtle d-flex align-items-center justify-content-center" style="min-height:100vh">
		<div class="card p-3 col-lg-6 m-4" style="border-radius:15px">
			<div class="row">
				<div class="kiri col-lg-4">
					<img src="foto.jpg" class="img-fluid col-12 rounded">
				</div>
