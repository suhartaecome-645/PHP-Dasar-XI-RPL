...
<body>
	<div class="container-fluid bg-img d-flex justify-content-center align-items-center">
		<div class="card p-4 pb-5 bg-glasses border border-light text-light col-lg-3 col-12">
			...
			<form method="post" action="">
				<div class="d-flex justify-content-between my-3">
					...
					<div class="col-3 ps-1">
						<button class="btn btn-outline-secondary btn-info col-12" type="submit" name="nilai" value="/">/</button>
					</div>
				</div>
				<div class="d-flex justify-content-between my-3">
					<div class="col-3 pe-1">
					...
					<div class="col-3 ps-1">
						<button class="btn btn-outline-secondary btn-info col-12" type="submit" name="nilai" value="*">x</button>
					</div>
				</div>
				<div class="d-flex justify-content-between my-3">
					<div class="col-3 pe-1">
